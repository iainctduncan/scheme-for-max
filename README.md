...
### 2020-05-06 This 0.1.5 release is the first windows beta. This required the main object to be renamed from s4m.scm to s4m
### Documentation for this change and demo videos are not yet updated. 
